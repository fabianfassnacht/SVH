...
##############
##### spectral variation vs. functional diversity
##############

load("spec4_100fd.RData")
load("spec8_100fd.RData")
load("spec12_100fd.RData")
load("spec16_100fd.RData")
load("spec20_100fd.RData")
load("spec21_100fd.RData")

png(filename = "scatter_simulations_func_div_21_07_11.png", height=2000, width=2000, res=300)

plot(unlist(spec4_fd), specvar, main="100 x 100", xlim=c(4,22), ylim=c(0, 1.3), ylab="Spec. Variability", xlab = "Species Count", cex.lab=1.2, cex.axis=1.2)
