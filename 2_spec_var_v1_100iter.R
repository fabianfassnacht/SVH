...
save(sv_4spec, file="sv_4spec_100iter.RData")
...
save(sv_8spec, file="sv_8spec_100iter.RData")
### 12 species
...
save(sv_12spec, file="sv_12spec_100iter.RData")
...
save(sv_16spec, file="sv_16spec_100iter.RData")
...
save(sv_20spec, file="sv_20spec_100iter.RData")
...
save(sv_22spec, file="sv_22spec_100iter.RData")
