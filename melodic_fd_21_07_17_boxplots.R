...
png(filename = "fd_boxplot.png", width=2500, height=1450, res=300)
par(mfrow=c(1,2))
boxplot(fd_all$abundance$mpd ~ fd_all$richness, ylab="Functional Diversity", xlab="Number of species", notch=T, cex.axis=1.3, cex.lab=1.1)
text(4.4,180, "A", cex=2)
boxplot(sv_4spec_1, sv_8spec_1, sv_12spec_1, sv_16spec_1, ylab="Spectral Variation", xlab="Number of species", axes=F, notch=T, cex.axis=1.3, cex.lab=1.1)
text(4.4,1.11, "B", cex=2)
box()
axis(1, at = 1:4, labels=c(4,8,12,16))
axis(2)
dev.off()
