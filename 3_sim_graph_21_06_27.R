...
setwd("D:/1_SVH_paper_24_06_21/5_simulation_graph/sim_ras/Figure_Paper")
fi <- list.files()
fi
...
rm(sv_4spec, sv_8spec, sv_12spec, sv_16spec, sv_20spec, sv_22spec)

colnames(raw) <- c("4", "8","12", "16","20", "22")
...
load("sv_22spec_100iter_agg2_v.RData")
...
colnames(agg2) <- c("4", "8","12", "16","20", "22")
...
load("sv_22spec_agg4_100iter.RData")
...
colnames(agg4) <- c("4", "8","12", "16","20", "22")
...
load("sv_22spec_agg10_100iter.RData")
...
colnames(agg10) <- c("4", "8","12", "16","20", "22")
...
# v1
beanplot(raw, ylim=c(0, 1.2), what = c(FALSE, TRUE, TRUE, FALSE), col="grey", main="Simulated images 100 x 100 pixels", xlab="Number of Species", ylab="Spec. Variability")
beanplot(agg2, ylim=c(0, 0.8), what = c(FALSE, TRUE, TRUE, FALSE), col="grey", main="Simulated images 100 x 100 pixels", xlab="Number of Species", ylab="Spec. Variability")
beanplot(agg4, ylim=c(0, 0.4), what = c(FALSE, TRUE, TRUE, FALSE), col="grey", main="Simulated images 100 x 100 pixels", xlab="Number of Species", ylab="Spec. Variability")
beanplot(agg10, ylim=c(0, 0.2), what = c(FALSE, TRUE, TRUE, FALSE), col="grey", main="Simulated images 100 x 100 pixels", xlab="Number of Species", ylab="Spec. Variability")

#v2
boxplot(raw, ylim=c(0, 1.2), col="grey", main="Simulated images 100 x 100 pixels", xlab="Number of Species", ylab="Spec. Variability")
boxplot(agg2, ylim=c(0, 1.2), col="grey", main="Simulated images 25 x 25 pixels", xlab="Number of Species", ylab="Spec. Variability")
boxplot(agg4, ylim=c(0, 1.2), col="grey", main="Simulated images 25 x 25 pixels", xlab="Number of Species", ylab="Spec. Variability")
boxplot(agg10, ylim=c(0, 1.2), col="grey", main="Simulated images 10 x 10 pixels", xlab="Number of Species", ylab="Spec. Variability")
...
specnr <- c(rep(4,100),rep(8,100),rep(12,100),rep(16,100),rep(20,100),rep(22,100))
...
png(filename = "simulations.png", height=1800, width=3400, res=300)
boxplot(all, ylim=c(0, 1.2), col=cols, xlab="Number of Species", ylab="Spec. Variability", cex.axis=1.2, cex.lab=1.4)
abline(v=6.5)
abline(v=12.5)
abline(v=18.5)
...
# 
# png(filename = "scatter_simulations.png", height=2000, width=2000, res=300)
# par(mfrow=c(2,2))
