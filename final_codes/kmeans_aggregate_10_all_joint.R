...
save(r_full_all_sp_ex, file="mosaiced_all_species_agg10_for_kmeans.Rdata")
...
boxplot(unlist(cl_sp_20cl)[1:100], 
        unlist(cl_sp_20cl)[101:200],
        unlist(cl_sp_20cl)[201:300],
        unlist(cl_sp_20cl)[301:400],
        unlist(cl_sp_20cl)[401:500], axes=F, ylab="number of kmeans clusters")
