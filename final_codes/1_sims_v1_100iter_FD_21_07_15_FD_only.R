...
for (i21 in 1:nrit){
  ...
  species21 <- sample(seq(1,20,1), dim_x*dim_y, replace=T)
...
for (i4 in 1:nrit){
  ...
  species4 <- sample(sample(seq(1,20,1),4, replace=F), dim_x*dim_y, replace=T)
...
for (i8 in 1:nrit){
  ...
  species8 <- sample(sample(seq(1,20,1),8, replace=F), dim_x*dim_y, replace=T)
...
for (i12 in 1:nrit){
  ...
  species12 <- sample(sample(seq(1,20,1),12, replace=F), dim_x*dim_y, replace=T)
...
for (i16 in 1:nrit){
  ...
  species16 <- sample(sample(seq(1,20,1),16, replace=F), dim_x*dim_y, replace=T)
...
for (i20 in 1:nrit){
  ...
  species20 <- sample(sample(seq(1,20,1),20, replace=F), dim_x*dim_y, replace=T)
