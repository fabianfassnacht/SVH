...
setwd("D:/1_SVH_paper_29_06_21/127_IAVS_special_issue_spectral_diversity/139_SVH_concept/Teja_SVH")
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_31may[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
  
}
polygon(c(1400,1500,1500,1400), c(0.01, 0.01, 0.9, 0.9), col = "white", border = "white")
polygon(c(1800,2000,2000,1800), c(0.01, 0.01, 0.9, 0.9), col = "white", border = "white")
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_20jun[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_7jul[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_11aug[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_6sep[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
...
for (i in 1:6){
  par(new=T)
  plot(bands, ds_20sep[i,dummy], lwd="2", ylim=c(0,0.9), type="l", xlim=c(300,2400), col=colgrad2[i], ylab="", xlab="", ann=F, axes=F)
