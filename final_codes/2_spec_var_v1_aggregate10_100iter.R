...
setwd("E:/KIT_Forschung/1_SVH_paper/5_sims_new/sim_ras")
...
save(sv_4spec, file="sv_4spec_agg10_100iter.RData")
...
save(sv_8spec, file="sv_8spec_agg10_100iter.RData")
### 12 species
...
save(sv_12spec, file="sv_12spec_agg10_100iter.RData")
...
save(sv_16spec, file="sv_16spec_agg10_100iter.RData")
...
save(sv_20spec, file="sv_20spec_agg10_100iter.RData")
...
save(sv_21spec, file="sv_21spec_agg10_100iter.RData")
