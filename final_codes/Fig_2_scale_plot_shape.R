require(rgdal)
setwd("D:/1_SVH_paper_29_06_21/127_IAVS_special_issue_spectral_diversity/1_Figure_1_scale")

grid_new <- readOGR(".", "grid")
setwd("D:/1_SVH_paper_29_06_21/127_IAVS_special_issue_spectral_diversity/1_Figure_1_scale/data")
